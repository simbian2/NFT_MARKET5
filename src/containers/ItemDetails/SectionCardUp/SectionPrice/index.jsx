            ...
            <ul className="list-group mt-15p">
                <li className="list-group-item border-0 d-flex align-items-center px-2">
                  ...
                  <div className="d-flex align-items-start flex-column justify-content-center">
                    <NavLink to="/" className="text-decoration-none"><h6 className="author-name">Thomp</h6></NavLink>
                    <NavLink className="btn btn-link autho-link text-decoration-none" to="/">@Mthomp</NavLink>
                  </div>
