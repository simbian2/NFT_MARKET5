  ...
  return(
      <li className="list-group-item border-0 d-flex align-items-center px-0 mb-2">
        ...
        <div className="d-flex align-items-start flex-column justify-content-center">
          <NavLink className="text-decoration-none" to={path2}><h6 className="author-name">{text1}</h6></NavLink>
          <NavLink className="btn btn-link autho-link text-decoration-none" to={path3}>{text2}</NavLink>
        </div>
