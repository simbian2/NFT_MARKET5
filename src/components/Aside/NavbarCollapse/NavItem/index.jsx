...
function NavItem({ path , ViewBox , title , transform2 , Id='' , transform4 , polygon=false , opacityPoly='' , points='' , D1 , opacityNormal , D2 , pathSVGMore=0 , D3='' , D4='' , opacity3='' , opacity4='' ,spanText }) {
  return (
