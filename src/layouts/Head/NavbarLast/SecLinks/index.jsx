...
function SecLinks(){
  ...
  let data = [
    {path:'/signup' , classIco:'fas fa-user-circle opacity-6  me-1' , text:'Sign Up'},
    {path:'/signin' , classIco:'fas fa-key opacity-6  me-1' , text:'Sign In'}
  ]
  ...
  return(
	  <div className="collapse navbar-collapse" id="navigation">
	    ...
	    <ul className="navbar-nav d-lg-block d-none">
	      <li className="nav-item">
	        <NavLink to="/connectwallet" className="btn btn-sm btn-round mb-0 me-1 bg-gradient-light">Connect Wallet</NavLink>
	      </li>
	    </ul>
	  </div>
  )
